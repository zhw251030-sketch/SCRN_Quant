...
if __name__ == '__main__':
    ...
    root = '/home/zhangxin/hanwen/Github/SCRN-main/data/train/' #The path to load the dataset.
    ...
    for i in range(len(xs)):
        np.save('/home/zhangxin/hanwen/Github/SCRN-main/TestData11/test_data_%d' % (i + 1), xs[i][0]) #The path to save.
